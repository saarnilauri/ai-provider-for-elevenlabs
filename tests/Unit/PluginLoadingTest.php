...
/**
 * Guards the manual class loading in ls-ai-provider-for-elevenlabs.php.
 *
...
class PluginLoadingTest extends TestCase
{
    public function testEveryClassFileUnderSrcIsRequiredByLoadClasses(): void
    {
        ...
        $this->assertSame(
            [],
            $missing,
            'These files under src/ are not required by load_classes() in ls-ai-provider-for-elevenlabs.php. '
     ...
     *
     * Read as text rather than by calling load_classes(), because ls-ai-provider-for-elevenlabs.php
    ...
    {
        $pluginFile = $this->repositoryRoot() . '/ls-ai-provider-for-elevenlabs.php';
